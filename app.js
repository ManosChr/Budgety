...
var budgetController = (function() {
    ...
    return {
        ...
        calculateBudget: function() {
            ...
            // Calculate the badget: income - expanses
...
var UIController = (function() {
    ...
    formatNumber = function(num, type) {
        ...
        */
        ...
        // Calculate the number's absolute value
        num = Math.abs(num);

        // Add 2 decimal points if they don't exist, or round the existing decimal points to 2, returns a string
        num = num.toFixed(2);
    ...
    return {
        ...
        clearFields: function() {
            ...
            // Trick to transform a list to an array
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var ctrlAddItem = function() {
        ...
        if (input.description !== "" && !isNaN(input.value) && input.value > 0) {
            // Add the iten to the budget controller
